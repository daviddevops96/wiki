...
3. **Define the relationships between the classes**, such as ``inheritance``, ``composition``, and ``use``. The Newspaper, Newsletter, and Magazine classes inherit fields and methods from the Periodical class. The Periodical class uses the Edition class.
