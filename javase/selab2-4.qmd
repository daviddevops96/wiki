...
Before coding, study this example:

  - First Version: [Birding 1.0](https://github.com/AlbertProfe/cifojava2022-1/tree/branch2test/Birding){.external}
  - Third Version: [Birding 3.0](https://github.com/AlbertProfe/JAVA_pqtm2019/tree/master/Birding/src){.external}
  - Fith Version: [Birding 5.0](https://github.com/AlbertProfe/JAVA_2020/tree/main/BirdingCloud){.external}
