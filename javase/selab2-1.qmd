...
- The **@Data** annotation is a ``Lombok`` annotation that generates getters and setters for the fields of a class, as well as equimport lombok.Data;als, hashCode, and toString methods based on the fields.
...
Adding lombok to your pom file: to include lombok as a provided dependency, add it to your <dependencies> block like so:
