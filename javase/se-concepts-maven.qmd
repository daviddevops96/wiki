...
Together, the groupId and artifactId help to uniquely identify a project within the Maven ecosystem.<!--- navLinks -->
<br><br>
<div class=row>
<br>
<div class='column left previous'>
<br>
[{{< fa solid arrow-left >}} Java MOOC Helsinki](/javase/se-what-moochelsinki.qmd)
<br>
</div>
<br>
...
<br>
[Java SE: Create Maven Project  {{< fa solid arrow-right >}}](/javase/se-concepts-createproject.qmd)
<br>
</div>
<br>
</div>
