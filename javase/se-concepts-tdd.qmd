...
4. Rerun the test and if they fail, then re##  `static` vs. `non-static`
...
<br>
[{{< fa solid arrow-left >}} Java SE: Project push GitHub](/javase/se-concepts-projectgit.qmd)
<br>
</div>
<br>
...
<br>
[Java SE: Class and Objects  {{< fa solid arrow-right >}}](/javase/se-concepts-objects.qmd)
<br>
</div>
<br>
</div>
