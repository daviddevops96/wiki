...
categories: [javase, abstraction , design-patterns, concepts]
toc: true
...
In other words, abstraction means <mark>representing the essential features of an object without including the non-essential details</mark>. In Java, abstraction is achieved through the use of abstract classes and interfaces.
...
<br>
[{{< fa solid arrow-left >}} Java SE: Encapsulation](/javase/se-principles-encapsulation.qmd)
<br>
</div>
<br>
...
<br>
[Java SE: Inherence  {{< fa solid arrow-right >}}](/javase/se-principles-inheritance.qmd)
<br>
</div>
<br>
</div>
