...
- [Learn X in Y minutes Where X=bash](https://learnxinyminutes.com/docs/bash/){.external}<!--- navLinks -->
<br><br>
<div class=row>
<br>
<div class='column left previous'>
<br>
[{{< fa solid arrow-left >}} Linux: basic concepts](/linux/linux-what-basics.qmd)
<br>
</div>
<br>
...
<br>
[Linux: su and sudo  {{< fa solid arrow-right >}}](/linux/linux-what-sudo.qmd)
<br>
</div>
<br>
</div>
