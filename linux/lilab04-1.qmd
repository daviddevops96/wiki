...
- [code on GitHub.com](https://github.com/AlbertProfe/qtool/blob/c2b0a47c6724750fc4e836d4661b199eb006e49e/_qtool/writenavigation.sh)
...
- [code on GitHub.com](https://github.com/AlbertProfe/qtool/blob/main/_qtool/debug.sh)
...
- [code on GitHub.com](https://github.com/AlbertProfe/qtool/blob/main/_qtool/dirtable.sh)
...
- [code on GitHub.com](https://github.com/AlbertProfe/qtool/blob/main/_qtool/yamltable.sh)
...
<br><br>
:::: {.columns}
::: {.column .previous width=40%} [{{< fa solid arrow-left >}} Linux Lab#LI03-4: Manage hardware](linux/lilab03-4.qmd):::
:::{.column .center width=20%} [{{< fa solid arrow-up >}} top](#top) :::
::: {.column .next width=40%} [Linux Lab#LI04-2: Bash scripts as terminal tool  {{< fa solid arrow-right >}}](linux/lilab04-2.qmd):::
::::
<br><br>
:::: {.columns}
<br>
::: {.column .previous width=40%}
<br>
