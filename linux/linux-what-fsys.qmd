...
![Linux File System, image from [Introduction to Linux, A Hands on Guide, Machtelt Garrels](https://tldp.org/LDP/intro-linux/html/index.html) and [Original webpage by Petersen Gross, modified by William Albritton](https://www2.hawaii.edu/~walbritt/ics240/materials/)](/images/linux/filesys-2.jpg){width=100%}<!--- navLinks -->
<br><br>
<div class=row>
<br>
<div class='column left previous'>
<br>
[{{< fa solid arrow-left >}} Linux: pipes](/linux/linux-what-pipes.qmd)
<br>
</div>
<br>
...
<br>
[Linux: Virtual Machines  {{< fa solid arrow-right >}}](/linux/linux-what-vm.qmd)
<br>
</div>
<br>
</div>
