...
[Why did we build React?](https://reactjs.org/blog/2013/06/05/why-react.html){.external}? We built React <mark>to solve one problem: building large applications with data that changes over time.<mark>

[Simple](https://beta.reactjs.org/learn#components){.external} and [fast](https://programmingwithmosh.com/react/react-virtual-dom-explained/){.external}, [very fast](https://codepen.io/embengineering/full/yOvmoW){.external}. *That it is.*
...
<br>
[React JS: render virtual DOM  {{< fa solid arrow-right >}}](/reactjs/reactjs-what-render-dom.qmd)
<br>
</div>
<br>
</div>
