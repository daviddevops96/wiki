...
These variables are used in the JSX code of the component to render the current state and to update the state in response to user actions. This allows the different types of code to be combined into a single, cohesive unit using **Hooks**.<!--- navLinks -->
<br><br>
<div class=row>
<br>
...
<br>
[React JS  {{< fa solid arrow-right >}}](/reactjs/hookstate.qmd)
<br>
</div>
<br>
</div>
