...
``Code blocks`` that use braces around the language name **(e.g. ```{python})** are executable, and [will be run by Quarto during render](https://quarto.org/docs/computations/python.html). Here is a simple example:
