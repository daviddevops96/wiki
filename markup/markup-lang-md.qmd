...
- [Obsidian](<https://www.markdownguide.org/tools/obsidian/>): A Markdown-based note-taking and organizing tool, with support for linking and organizing notes using graphs and diagrams.<!--- navLinks -->
<br><br>
<div class=row>
<br>
<div class='column left previous'>
<br>
[{{< fa solid arrow-left >}} HTML Markup](/markup/markup-lang-html.qmd)
<br>
</div>
<br>
...
<br>
[Markdown and HTML working together, good idea?  {{< fa solid arrow-right >}}](/markup/markup-lang-html-md.qmd)
<br>
</div>
<br>
</div>
