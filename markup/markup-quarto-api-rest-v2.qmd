...
viewof loadingMessage = {};
viewof contributors = {};
viewof commits = {};
viewof author = {};
viewof contributor = {};

viewof fetchButton = Inputs.button("fetch", {
async function() {
loadingMessage.value = "Loading...";
contributors.value = await d3.json("https://api.github.com/repos/albertprofe/wiki/stats/contributors");


commits.value = contributors.value.map(contributor.value => {
  
  author.value = contributor.value.author;
  return {
    name: author.login,
    title: author.login,
    group: author.type,
