...
1. Install some software and Sign in:
    1. Install **Visual Code**
      1. Install GitHub Extension and Source Control if they don't come with new installation
      2. Install **Quarto Extension** in Visual Code
    2. Sign in GitHub from Visual Code (wizard)
    2. Install **Quarto** in your OS (download from [Quarto site - Get started](https://quarto.org/docs/get-started/))
...
## Screen-shoots (2022-12-12)

[Log in to GitHub and Quarto Creation](https://drive.google.com/drive/folders/1fV85crifRwAvL63ERIRhPmIoTsbsEeTW?usp=share_link)

## Screen-shoots (2022-12-08)
