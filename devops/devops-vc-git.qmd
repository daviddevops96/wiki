...
![Diagram showing some common Git operations by [Daniel Kinzler wikicommons](https://commons.wikimedia.org/wiki/User:Duesentrieb "User:Duesentrieb")](https://upload.wikimedia.org/wikipedia/commons/d/d8/Git_operations.svg)
