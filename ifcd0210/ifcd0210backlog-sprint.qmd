...
|  | 18 | 19/01 | - 1:n / onetomany / @OneToMany</br> - Example (1) oneToMany: Director/Movie</br> - Project structure: .gitignore, readme.md, uml.md</br> | [Java Persistence](https://en.wikibooks.org/wiki/Java_Persistence){.external}</br> [MovieManager Code](https://github.com/AlbertProfe/CifoJava2023/tree/master/MovieManger){.external} |
|  | 19 | 20/01 | - Library Model Basic/Large</br> - Example (3) manyToMany: memberLibrary/Book, Customer/Product, Director/Movie</br> - SCRUM Projects: (1) Management (2) Meetings Rules (3) Mistakes (4) Roles</br> - spaceX: all requirements are dumb</br> -  Model is the answer at Why: Why? (1) Desire (2) Need (3) Natural aspiration</br> - After solving the Why apperars the How: we need Tools > Decision-making & Albertus' dylema | [SCRUM](/scrum/scrum-what-concepts.qmd)  </br>[Lab#SE00-3 Basic](/javase/selab0-3.qmd#basic-uml) </br>[Lab#SE00-3 Large](/javase/selab0-3.qmd#large-uml)</br>[All requirements are dumb](https://modelthinkers.com/mental-model/musks-5-step-design-process){.external}  |
