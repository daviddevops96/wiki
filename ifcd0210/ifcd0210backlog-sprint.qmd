...
|  | 21 | 24/01 | - MovieManager Domains & Packages, connecting classes: static/non-static and reusable method/class (2/3)</br> - Hashmap</br> - Try and Catch</br>- Test interactivity</br> | [Movie Manager](https://github.com/AlbertProfe/CifoJava2023/tree/){.external}</br>  [HashMap w3school](asp){.external}</br> |
|  | 22 | 25/01 | - Library Model Basic/Large</br> - Example (3) manyToMany: memberLibrary/Book, Customer/Product, Director/Movie</br> - Quarto</br>  - MovieManager Domains & Packages: connecting classes (3/3)</br>  | [Lab#SE00-3 Basic](/javase/selab0-3.qmd#basic-uml) </br>[Lab#SE00-3 Large](/javase/selab0-3.qmd#large-uml)</br> |
